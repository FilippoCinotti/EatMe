...
The reference feature extension is tracked in [PR #15](https://github.com/FilippoCinotti/EatMe/pull/15). Read [reference feature parity](reference-feature-parity.md) for the new flows, API contracts, data boundaries and current verification status. Baseline native-build evidence above does not substitute for the feature branch CI.
