export default function Terms() {
  ...
  return <main><header><a className="brand" href="/">EatMe</a><span>Terms of use</span></header><h1>Use EatMe thoughtfully.</h1>
    ...
    <h2>Optional subscriptions</h2><p>Available prices, periods and trial conditions are displayed by your app store before purchase. Store subscriptions renew under the terms displayed there. Manage cancellation and refunds through the store. Account deletion does not cancel a store subscription.</p>
