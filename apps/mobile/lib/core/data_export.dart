...
class DataExport {
  static Future<Directory> directory() async => Directory('${(await getTemporaryDirectory()).path}/eatme-exports');
  ...
  static Future<void> share(BuildContext context, Json data) async {
    ...
    await SharePlus.instance.share(ShareParams(files: [XFile(file.path, mimeType: 'application/json')],
      title: 'EatMe data export', sharePositionOrigin: box == null ? null : box.localToGlobal(Offset.zero) & box.size));
